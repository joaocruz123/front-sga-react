...
export const URL_DOWNLOAD_APP = process.env.REACT_APP_URL_DOWNLOAD_APP || 'https://giraffas.page.link/app'
export const GTM_KEY = process.env.REACT_APP_GTM_KEY || 'true'
